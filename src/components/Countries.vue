        ...
        <div class="borders">
          <div class="bordersWrapper">
            ...
            <span v-for="countryBorderDetails in borderCountries" v-bind:key="countryBorderDetails.id" class="borderList">
              <router-link :to="{ name: 'Countries', params: { country: countryBorderDetails.name }}" class="borderLinks">
...
axios
   ...
   .then(async (response) => {
    ...
    this.alpha3Code = this.countryInfo['0'].borders
       ...
       return (this.borderCountries=response_1.data);
     } catch(error) {
       return (this.errorBorders=error);
     }
})
